...
public class Tarea {
    ...
    public Tarea(String titulo, String descripcion, List<Persona> listaPersonasAsignadas, Persona responsable, MenuPrioridad prioridad, Resultado resultado, List<String> listaEtiquetas) {
        this.titulo = titulo;
